...
import de.ocp.cassandrakafka.domain.Foo;
import de.ocp.cassandrakafka.repository.FooRepository;
...
import static de.ocp.cassandrakafka.web.rest.TestUtil.createFormattingConversionService;
...
public class FooResourceIntTest extends AbstractCassandraTest {
    ...
    public void createFoo() throws Exception {
        ...
        assertThat(testFoo.getFoo()).isEqualTo(DEFAULT_FOO);
    }
    ...
    public void getAllFoos() throws Exception {
        ...
        restFooMockMvc.perform(get("/api/foos"))
            ...
            .andExpect(jsonPath("$.[*].foo").value(hasItem(DEFAULT_FOO.toString())));
    }
    ...
    public void getFoo() throws Exception {
        ...
        restFooMockMvc.perform(get("/api/foos/{id}", foo.getId()))
            ...
            .andExpect(jsonPath("$.foo").value(DEFAULT_FOO.toString()));
    }
    ...
    public void updateFoo() throws Exception {
        ...
        Foo testFoo = fooList.get(fooList.size() - 1);
        assertThat(testFoo.getFoo()).isEqualTo(UPDATED_FOO);
    }
